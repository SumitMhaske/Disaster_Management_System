...
df.to_csv(r"D:\Downloads/ML1\DisasterAlert (8)\DisasterAlert (8)\data/real_time_india_earthquakes_with_states.csv", index=False)
print("Updated earthquake data saved with state information.")

# Load and filter processed earthquake data
processed_file = r"D:\Downloads/ML1\DisasterAlert (8)\DisasterAlert (8)\data/processed_earthquake_data.csv"
try:
...
try:
    ...
    df_ml.to_csv(r"D:\Downloads/ML1\DisasterAlert (8)\DisasterAlert (8)\data/ml_ready_india_earthquakes.csv", index=False)
